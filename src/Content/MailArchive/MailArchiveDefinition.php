...
class MailArchiveDefinition extends EntityDefinition
{
    ...
    protected function defineFields(): FieldCollection
    {
        return new FieldCollection([
            ...
            (new JsonField('cc', 'cc'))->addFlags(new SearchRanking(SearchRanking::HIGH_SEARCH_RANKING)),
            (new JsonField('bcc', 'bcc'))->addFlags(new SearchRanking(SearchRanking::HIGH_SEARCH_RANKING)),
