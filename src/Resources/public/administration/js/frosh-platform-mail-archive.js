(()=>{var c=Shopware.Classes.ApiService,h=class extends c{constructor(t,r,a="frosh-mail-archive"){super(t,r,a)}resendMail(t){let r=this.getBasicHeaders({});return this.httpClient.post(`_action/${this.getApiBasePath()}/resend-mail`,{mailId:t},{...this.basicConfig,headers:r}).then(a=>c.handleResponse(a))}downloadMail(t){let r=this.getBasicHeaders({});return this.httpClient.post(`_action/${this.getApiBasePath()}/content`,{mailId:t},{...this.basicConfig,headers:r}).then(a=>{let i=c.handleResponse(a);if(!i.success)return i;let s=window.URL.createObjectURL(new Blob([i.content])),l=document.createElement("a");l.href=s,l.setAttribute("download",i.fileName),document.body.appendChild(l),l.click()})}downloadAttachment(t){let r=this.getBasicHeaders({});return this.httpClient.post(`_action/${this.getApiBasePath()}/attachment`,{attachmentId:t},{...this.basicConfig,headers:r}).then(a=>{let i=c.handleResponse(a);if(!i.success)return i;let s=document.createElement("a");s.href="data:"+i.contentType+";base64,"+i.content,s.setAttribute("download",i.fileName),document.body.appendChild(s),s.click()})}},d=h;var{Application:m}=Shopware;m.addServiceProvider("froshMailArchiveService",e=>{let t=m.getContainer("init");return new d(t.httpClient,e.loginService)});var p=`<sw-page>
